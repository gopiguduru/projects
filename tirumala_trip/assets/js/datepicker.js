 ...
 *
 * Copyright (c) 2014-2017 Chen Fengyua
...
}(this, (function (Rs) { 'use strict';

Rs = Rs && Rs.hasOwnProperty('default') ? Rs['default'] : Rs;
...
var methods = {
  ...
  show: function show() {
    ...
    if (!this.inline) {
      Rs(window).on(EVENT_RESIZE, this.onResize = proxy(this.place, this));
      Rs(document).on(EVENT_CLICK, this.onGlobalClick = proxy(this.globalClick, this));
      Rs(document).on(EVENT_KEYUP, this.onGlobalKeyup = proxy(this.globalKeyup, this));
      this.place();
    }
  },
